...
@section('content')
  <div class="p-userMainContainer">
    ...
    <div class="p-userMainContainer__formWrap">
      ...
      <!-- 入力フォーム -->
      <input type="text" class="p-formInput" type="text" name="store-name">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      ...
      <span class="p-formAttention">※必須</span>
      <!-- 入力フォーム -->
      <input type="text" class="p-formInput" type="text" name="branch-name">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      <div class="p-formValidate">
        <ul>
          <li>※入力必須</li>
      ...
      <!-- 入力フォーム -->
      <input type="text" class="p-formInput" type="text" name="building-name">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      <div class="p-formValidate">
        <ul>
          <li>※入力必須</li>
