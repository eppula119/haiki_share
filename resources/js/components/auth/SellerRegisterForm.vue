<template>
  <div class="p-authContainer">
    ...
    <form action="#" class="p-authContainer__form" method="post">
      ...
      <!-- 入力フォーム -->
      <input class="p-authInput" type="text" name="store-name">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      ...
      <span class="p-authAttention">※必須</span>
      <!-- 入力フォーム -->
      <input class="p-authInput" type="text" name="branch-name">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      <div class="p-authValidate">
        <ul>
          <li>※入力必須</li>
      ...
      <span class="p-authAttention">※必須</span>
      <!-- 入力フォーム -->
      <input class="p-authInput" type="text" name="city">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      <div class="p-authValidate">
        <ul>
          <li>※入力必須</li>
      ...
      <!-- 入力フォーム -->
      <input class="p-authInput" type="text" name="building-name">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      <div class="p-authValidate">
        <ul>
          <li>※入力必須</li>
      ...
      <span class="p-authAttention">※必須</span>
      <!-- 入力フォーム -->
      <input class="p-authInput" type="password" name="password">
      <!-- バリデーションエラーメッセージ表示箇所 -->
      <div class="p-authValidate">
        <ul>
          <li>※入力必須</li>
